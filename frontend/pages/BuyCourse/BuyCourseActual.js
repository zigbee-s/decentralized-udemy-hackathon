...
const BuyCourseActual = ({ marketPlace }) => {
  ...
  console.log(price, name, sender)
  // Function to handle Buy Now button click
  const handleBuyNow = async () => {
    // Perform any actions or logic you want when Buy Now is clicked
    // For example, you can navigate to a new page or show a modal
    // In this case, we will simply log a message to the console
    let res = await marketPlace.buyCourse("gauraang.testnet", price)
    console.log("res");
  };
